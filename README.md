...
Engineering student focused on **embedded systems**, **hardware/software integration**, and **developing stronger firmware skills**, with growing interest in **robotics**.

I enjoy building real hardware/software systems, especially projects that include:
- microcontrollers
- sensors and control logic
- bring-up, debugging, testing, and iteration

## Featured Projects

### [ESP32 Line-Following and Gap-Crossing Rover](https://github.com/philippkurle/ESP32-Line-Following-And-Gap-Crossing-Rover)
...
- **Languages / exposure:** MicroPython, beginner C++, beginner Python
- **Embedded:** ESP32, Arduino
- **Engineering Tools:** multimeter, Git, PlatformIO, basic oscilloscope use
